...
const OnboardingForm = () => {
    ...
    const availabilityOptions = ['Immediate', 'Less than 3 months', 'More than 3 months'];
    const preferredRoleTypeOptions = ['Full Time', 'Part Time', 'Intern'];
    const preferredWorkArrangementOptions = ['Remote', 'On-site', 'Hybrid'];
            ...
            <div className="w-full max-w-3xl bg-white bg-opacity-30 backdrop-blur-lg p-8 rounded-xl shadow-lg space-y-6">
                ...
                <form onSubmit={handleNext} className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div className="w-full px-2 mb-4">
                                ...
                                <select
                                    ...
                                    className="w-full p-2 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-200 focus:outline-none transition-all ease-in-out duration-200 shadow-md"
                                >
                            ...
                            <div className="w-full px-2 mb-4">
                                ...
                                >
                                    ...
                                    {preferredRoleTypeOptions.map((option, index) => (
                                        <option key={index} value={option}>{option}</option>
                                    ))}
                                </select>
                            </div>

                            {/* Preferred Work Arrangement Dropdown */}
                            <div className="w-full px-2 mb-4">
                                ...
                                <select
                                    ...
                                    className="w-full p-2 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-200 focus:outline-none transition-all ease-in-out duration-200 shadow-md"
                                >
                                    <option value="">Select Preferred Work Arrangement</option>
                                    {preferredWorkArrangementOptions.map((option, index) => (
                                        <option key={index} value={option}>{option}</option>
                                    ))}
                                </select>
                            </div>
                    ...
                    <div className="flex justify-between mt-6">
                        ...
                        <button
                            type="submit"
                            className="bg-gradient-to-r from-[#15abcd] to-[#094DA2] text-white py-3 px-6 rounded-lg shadow-md hover:bg-teal-600 focus:ring-2 focus:ring-teal-300 focus:outline-none transition-all ease-in-out duration-200"
                        >
                            {step === 2 ? 'Submit' : 'Next'}
                        </button>
                    </div>
